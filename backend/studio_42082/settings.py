"""
Django settings for studio_42082 project.
...
ROOT_URLCONF = 'studio_42082.urls'
...
WSGI_APPLICATION = 'studio_42082.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "studio_42082 API",
    "DESCRIPTION": "API documentation for studio_42082 App",
    "VERSION": "v1",
}
